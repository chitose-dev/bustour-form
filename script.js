...
function showReservationDetail(id) {
    ...
    body.innerHTML = ''
        ...
        + '<div><label class="block text-gray-600 text-sm mb-1">メモ</label><textarea id="edit-res-manual-memo" class="w-full border p-2 rounded text-sm resize-none" rows="3" placeholder="この予約のメモ">' + (r.manualMemo || '').replace(/</g, '&lt;').replace(/>/g, '&gt;') + '</textarea></div>'
